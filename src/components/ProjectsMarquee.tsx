...
export default function ProjectsMarquee() {
  const renderRow = (items: string[], direction: "left" | "right") => {
    ...
    return (
      <div className="relative flex w-full overflow-hidden border-y border-[#CAA365]/25 bg-[#2D1A10] py-5 my-1.5 shadow-sm">
        {/* Left fade gradient */}
        <div className="absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#2D1A10] via-[#2D1A10]/50 to-transparent z-20 w-16 pointer-events-none" />
        ...
        {/* Right fade gradient */}
        <div className="absolute right-0 top-0 bottom-0 bg-gradient-to-l from-[#2D1A10] via-[#2D1A10]/50 to-transparent z-20 w-16 pointer-events-none" />
      </div>
    );
  };
